...
{
	public partial class StatusOfDBRun : BaseControls.BaseUserControl
	{
		List<KeyValue> ListOfDB;
		public StatusOfDBRun(List<KeyValue> listOfDB)
		{
			InitializeComponent();
			ListOfDB = listOfDB;
		...
		private void StatusOfDBRun_Load(object sender, EventArgs e)
		{
			FillDBDropDownList();
